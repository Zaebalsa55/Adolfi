  ...
  return (
    <>
      <div className="frame1196-container10">
        ...
        <div className="frame1196-image7-placeholder">
          <svg
        ...
        <span className="frame1196-text166">
          ...
          <span className="frame1196-text170">
            ...
            владельцев. Важно доверить ремонт пров������ре��ным специалистам, а ��е
            случайному мастеру.
          </span>
          <br />
          <br />
          ...
          <span>
            ...
            частые пр��чины, по которым клиенты обращаются в наш сервис:
          </span>
          <br />
          <span>
